...
Welcome to the world of okapis [okapis](https://maeltha.github.io/website/)! This is an [MIT licensed](https://github.com/maeltha/website/blob/main/LICENSE) React-based Jamstack application. It offers a simple interface, easy modifications, static export capabilities, and free automatic deployments via [GitHub Pages](https://pages.github.com/).
...
1. Clone the repository:
   ...
   ```bash
   git clone git://github.com/maeltha/website.git
   cd website
   ```
...
This will generate a static version in `website/build/` which you can host or deploy to a CDN.
...
- Kudos to [@notrueblood](https://github.com/notrueblood)[<sup>[1]</sup>](https://github.com/maeltha/website/pull/218) and [@sjhsieh](https://github.com/sjhsieh)[<sup>[2]</sup>](https://github.com/maeltha/website/issues/168) for their constructive feedback.
