...
describe('renders the app', () => {
  ...
  it('should render the title', async () => {
    expect(document.title).toBe("Oh Oka Pi");
  });
  ...
  it('can navigate to /schaberbracken', async () => {
    expect.assertions(3);
    ...
    expect(document.title).toContain('Schaberbracken |');
    expect(window.location.pathname).toBe('/schaberbracken');
  });

  it('can navigate to /okapi', async () => {
    expect.assertions(3);
    const contactLink = document.querySelector(
    ...
    expect(document.title).toContain('okapi |');
    expect(window.location.pathname).toBe('/okapi');
  });
